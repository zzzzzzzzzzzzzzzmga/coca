...
if [ "$choose_node_aiko" == 0 ]; then
  ...
  wget https://raw.githubusercontent.com/ezDiGi/keypem/main/key.pem -O /etc/XrayR/server.pem
  wget https://raw.githubusercontent.com/ezDiGi/keypem/main/privkey.pem -O /etc/XrayR/privkey.pem
